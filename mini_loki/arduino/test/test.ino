...
int speed1Pin = D1;
int direction1Pin = D2;
int speed2Pin = D3;
int direction2Pin = D4;
int speed3Pin = D7;
int direction3Pin = D8;
...
void loop() {
  ...
  for (int fadeValue = 0 ; fadeValue < 1024; fadeValue += 5) {
    ...
    analogWrite(speed1Pin, fadeValue);
    analogWrite(speed2Pin, fadeValue);
    analogWrite(speed3Pin, fadeValue);
